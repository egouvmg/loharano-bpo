...
<head>
    ...
    <title>Loharano - Tableau de bord des doublons</title>
...
<body class="loharano">
  ...
  <div class="container-fluid page-title">
    <h1>Liste des personnes dupliquées</h1>
  </div>

	<div class="tab-content" id="nav-tabContent">
		<!-- Tab menages-->
		<div class="tab-pane fade show active" id="nav-memange" role="tabpanel" aria-labelledby="nav-menage-tab">
			<!-- Page Content -->
			<div class="container-fluid main-container" style="padding-top: 24px;">
				...
				<div class="form-row">
					<div class="form-group col-md-6">
						<label>Critère de détection de doublons</label>
						<input type="text" value="<?= $this->lang->line('last_name');?> - <?= $this->lang->line('first_name');?> - <?= $this->lang->line('birth');?> - <?= $this->lang->line('birth_place');?> - <?= $this->lang->line('mother');?>" readonly class="form-control"/>
					</div>
					<!-- <div class="form-group col-md-2">
						<label>Nombre de personnes</label>
						<input type="text" readonly id="people" class="form-control"/>
					</div> -->
				</div>
  ...
  <script src="<?= plugin('tabulator', 'js', 'tabulator.min.js');?>"></script>
	<script src="<?= plugin('modules', 'admin', 'duplicate_person.js');?>"></script>
