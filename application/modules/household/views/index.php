...
<head>
  ...
  <title>Loharano - Tableau de bord des ménages</title>
...
<body class="loharano">
  ...
  <script src="<?= plugin('tabulator', 'js', 'tabulator.min.js');?>"></script>
	<script src="<?= plugin('modules', 'admin', 'household.js');?>"></script>
