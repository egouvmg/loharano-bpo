...
<head>
  ...
  <title>Loharano - Liste des personnes</title>
...
<body class="loharano">
  ...
  <div class="container-fluid page-title">
    <h1>Liste des personnes par Fokontany</h1>
    <a href="tableau_bord_societe">
      ...
      <div class="form-group col-md-4">
        ...
        <select id="fokontany" class="form-control">
          <?php foreach ($fokontany as $f): ?>
          	<option value="<?= $f->fokontany_id;?>"><?= $f->name;?></option>
          <?php endforeach ?>
        </select>
      </div>
      <div class="form-group col-md-2">
        <label>Personnes traitées</label>
        <input type="text" id="treatyPeople" value="<?= format_number($total_drf->nbr_people);?>" class="form-control" readonly/>
      </div>
    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
      <div class="modal-content">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-5">
                <label for="pdf_file"><?= $this->lang->line('pdf_file');?><span class="text-red">*</span></label>
                <input type="text" name="pdf_file" class="form-control pdf_file" id="pdf_file"/>
                <div class="error_field pdf_fileError"></div>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-4">
  ...
  <!-- Bootstrap core JavaScript -->
    ...
    <script src="<?= plugin('modules', 'company', 'list.js');?>"></script>
</body>
