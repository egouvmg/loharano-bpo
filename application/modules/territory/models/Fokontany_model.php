...
class Fokontany_model extends CI_Model
{
	...
	private $_v_number_person_treaty = "v_number_person_treaty";
	...
	public function person_treaty_by_fokontany($criteria = array()) {
		$this->db->select('*');
		$this->db->from($this->_v_number_person_treaty);
